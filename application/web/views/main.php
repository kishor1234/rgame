...
<html lang="en">
    ...
    <body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0">
        ...
        $rawSeries = json_decode($main->postJsonRespon(api_url . "/?r=loadSeries", array()), true);
                        ...
                        <div class="tab-pane fade active in" id="today">
                            ...
                            <div id="myTabContent" class="tab-content">
                                ...
                                foreach ($series as $key => $val) {
                                    $i = 1;
                                    $p++;
                                    $result = json_decode($main->jsonRespon(api_url . "/?r=result", array("series" => $val["series"], "gdate" => $today)), true);
                                    if ($p == 1) {
                                        ?>
                                        <div class="tab-pane fade active in" id="today<?= $val["id"] ?>">
                                            ...
                                            foreach ($result as $k => $vl) {
                                                ...
                                                if (strtotime($vl["gameetime"]) < strtotime(date("H:i:s"))) {
                                                    if ($i == 1) {
                                                        ?>
